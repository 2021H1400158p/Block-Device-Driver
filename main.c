...
static int __init mydisk_init(void)
{
    ...
    if (mydisk_major <= 0) 
    {
        printk(KERN_ALERT "Unable to allot Major Number to the device\n");
        return -EBUSY;
    }
    ...
    printk(KERN_INFO "Block Device Initialised");
...
MODULE_AUTHOR ( "Surbhika Kumari<h20210158@pilani.bits-pilani.ac.in>" );
MODULE_LICENSE ( "GPL" );
